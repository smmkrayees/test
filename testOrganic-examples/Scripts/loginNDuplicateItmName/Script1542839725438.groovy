...
WebUI.setText(findTestObject('Object Repository/Page_organic - Stock Registration/input_ox_organic_Item__itemNam'), 'LOLLY POP')
...
WebUI.doubleClick(findTestObject('Page_organic - Stock Registration/td_Impossible to execute Save'))
